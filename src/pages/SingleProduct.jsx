    ...
    <section className="font-dm bg-">
      <Container>
        ...
        {loading ? (
          ...
          <Flex
            className={
              "mt-10 lg:grid-cols-3 grid sm:grid-cols-2 flex-wrap lg:gap-2 lg:gap-y-5 gap-x-5 gap-y-10"
            }
          >
            {product.images.length &&
              product.images.map((value) => (
                <Img
                  ...
                  className={"w-32%"}
                  imgClassName={
                    "md:w-[382px] md:h-[330px] sm:w-[310px] sm:h-[310px] w-full"
                  }
                />
              ))}
          </Flex>
        ...
        >
          ...
          <Flex
            className={
              "w-full py-4 border-b-[1px] border-[#F0F0F0] items-center gap-x-10"
            }
          >
          ...
          <Flex
            className={
              "w-full py-4 border-b-[1px] border-[#F0F0F0] items-center"
            }
          >
          ...
          <div className="py-4 border-b-[1px]  border-[#F0F0F0]">
            ...
            >
              ...
              <span className="text-2xl font-bold">
                {feturesShow ? <IoMdRemove /> : <IoMdAdd />}
              </span>{" "}
            </h5>
            {feturesShow && (
              <p className="text-[#767676] text-base font-normal  ">
                ...
                magnam temporibus corporis voluptates. Pariatur repellat dolorem
                a placeat at accusamus, voluptate nam ratione. Officia omnis
                quasi eligendi incidunt ratione dolorem. Alias fuga veniam omnis
                illum.
              </p>
            )}
          </div>
          ...
          <div className="py-4 border-b-[1px] border-[#F0F0F0]">
            ...
            >
              SHIPPING & RETURNS{" "}
              <span className="text-2xl font-bold">
                {shippingShow ? <IoMdRemove /> : <IoMdAdd />}
              </span>{" "}
            </h5>
            {shippingShow && (
              <p className="text-[#767676] text-base font-normal ">
        ...
        <Flex className={"mt-20 flex-col"}>
          ...
          {show ? (
            ...
            <div>
              <h5 className="text-[#767676] text-sm pt-9 pb-3 border-b-[1px] border-[#F0F0F0]">
                1 Review for Product
              </h5>
              <Flex
                className={
                  "w-full flex-col pt-9 pb-3 border-b-[1px] border-[#F0F0F0] text-base"
                }
              >
              ...
              <div className={"my-11"}>
                <h5 className="text-[#262626] text-xl font-bold">
                  Add a Review
                </h5>
              </div>
              <div>
                <label className="text-[#262626] text-base font-bold block">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div className="mt-6">
                <button className="text-[#fafafa] bg-slate-800 hover:bg-[#000000] w-[200px] h-[50px] font-bold text-center border border-[#262626] transition-all duration-75">
                  Send
                </button>
              </div>
            </div>
