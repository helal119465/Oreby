    ...
    <div className=' relative z-10' ref={cart}>
        <FaShoppingCart className='text-xl cursor-pointer'/>
        {
          ...
          <div className='bg-[#FFFFFF] p-5'>
              ...
              <Flex className={'mt-4'}>
                <Button title={"View Cart"} linkClassName={' text-[#262626] text-sm font-bold py-4 px-10 border border-[#2B2B2B] hover:bg-indigo-950 hover:text-white transition-all duration-500 '} link={'/cart'}/>
                <Button title={"Checkout"} linkClassName={'text-[#FFFFFF] bg-[#262626] text-sm font-bold py-4 px-10 ml-5 hover:text-slate-500 hover:bg-lime-300 transition-all duration-500'} link={'/checkOut'}/>
              </Flex>
          </div>
        </DropDownItem>
        }
