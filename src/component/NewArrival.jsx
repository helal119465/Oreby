...
function SampleNextArrow(props) {
  ...
  return (
    <span
      ...
      onClick={onClick}
    >
      <FaLongArrowAltRight className="text-white text-4xl" />
    </span>
  );
}
...
function SamplePrevArrow(props) {
  ...
  return (
    <span
      ...
      onClick={onClick}
    >
      <FaLongArrowAltLeft className="text-white text-4xl" />
    </span>
  );
}
const NewArrival = () => {
  ...
  return (
    <section className="">
      <Container>
        ...
        <Flex
          className={
            "gap-9 md:gap-5 lg:gap-9 xl:gap-[50px] sm:flex-row flex-col flex-wrap"
          }
        >
          <Products
