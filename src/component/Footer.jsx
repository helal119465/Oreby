...
const Footer = () => {
  return (
    <footer className="font-dm bg-[#F5F5F3] md:mt-32 mt-10">
      <Container>
        <Flex className={"pt-[55px] md:pb-[65px] pb-8  flex-wrap"}>
          <div className="xl:w-[180px] md:w-[110px] w-[80px]  font-bold h-[200]">
            ...
            <List className={"text-sm text-[#6D6D6D] font-normal leading-7"}>
              <ListItem
                ...
                link={"/"}
                linkClassName={
                  "hover:font-bold hover:text-[#262626] transition-all duration-500"
                }
              />
              <ListItem
                item={"Shop"}
          ...
          <div className="xl:w-[410px] md:mt-0 mt-8">
            ...
            <h6>
              <address className="text-sm text-[#6D6D6D]">
        ...
        <Flex
          className={"pb-3 justify-between items-center sm:flex-row flex-col"}
        >
          ...
          <h5 className="text-[#6D6D6D] md:text-sm text-xs">
